...
{
    public class QRCodeHelper : ControllerBase
  { 
      Byte[] b;
     public async  Task<string> QRCode(IWebHostEnvironment webHostEnvironment,string QRId ,string myfile,string location, string ConcatLocation)
     { 
      ...
      brcode.Draw(QRId, 60).Save(ms, System.Drawing.Imaging.ImageFormat.Jpeg);
      ms.ToArray();
      Image image; 
